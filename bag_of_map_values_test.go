...
func TestBagOfMapValues(t *testing.T) {
	tests := []struct {
		name          string
		bag           views.Bag[int]
		wantLen       int
		...
		{
			name:          "non-empty map",
			bag:           views.BagOfMapValues[string, int]{M: map[string]int{"a": 1, "b": 2, "c": 3}},
			wantLen:       3,
		...
		{
			name:          "empty map",
			bag:           views.BagOfMapValues[string, int]{M: map[string]int{}},
			wantLen:       0,
			wantValues:    nil,
		...
		{
			name:          "nil map",
			bag:           views.BagOfMapValues[string, int]{},
			wantLen:       0,
			wantValues:    nil,
			missingValues: []int{1, 2, 3},
		},
